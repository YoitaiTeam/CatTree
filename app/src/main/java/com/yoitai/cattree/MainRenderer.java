...
public class MainRenderer implements GLSurfaceView.Renderer {
    // 定義
    public static final int MAX_TEXTURE = 150;        // 最大テクスチャ数
    ...
    public DrawParams[] getTargetDrawParams() {
        return (mDrawParams[mTargetDrawParamsNo]);
    }

    public DrawParams allocDrawParams() {
        return (mDrawParams[mTargetDrawParamsNo][mCurDrawParamNo++]);
    }

    public Texture getTexture(int _no) {
        return (mTextures[_no]);
    }
